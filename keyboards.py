...
def main_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="Наши нейл-мастера", callback_data="masters"),
...
def admin_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="Нейл-мастера", callback_data="admin_masters"),
...
def admin_masters_kb() -> InlineKeyboardMarkup:
    ...
    for i in range(0, len(master_list), 2):
        ...
        buttons.append(row)
    buttons.append([InlineKeyboardButton(text="Добавить нейл-мастера", callback_data="admin_add_master")])
