...
def welcome_text(name: str) -> str:
    ...
    return (
        f"{E.BARBER} <b>Добро пожаловать в студию маникюра «{html_module.escape(name)}»!</b>\n\n"
...
BOOKING_CONFIRM = (
    ...
    f"{E.SCISSORS} <b>Нейл-мастер:</b> {{master}}\n"
...
MASTER_INFO = (
    f"{E.SCISSORS} <b>Нейл-мастер: {{name}}</b>\n\n"
...
ADMIN_MASTER_LIST = "Нейл-мастера:\n\n{masters}"
ADMIN_MASTER_ADDED = "Нейл-мастер {name} добавлен."
ADMIN_MASTER_REMOVED = "Нейл-мастер {name} удалён."
ADMIN_MASTER_UPDATED = "Нейл-мастер {name} обновлён."
ADMIN_MASTER_NOT_FOUND = "Нейл-мастер {name} не найден."
ADMIN_ADD_MASTER_PROMPT = "Добавление нейл-мастера\n\nФормат: Имя, опыт, специализация\nПример: Анна, 5 лет, классический маникюр"
ADMIN_EDIT_MASTER_PROMPT = "Редактирование нейл-мастера\n\nФормат: Имя, опыт, специализация\nПример: Анна, 6 лет, маникюр, гель-лак"
ADMIN_REMOVE_MASTER_PROMPT = "Выберите нейл-мастера для удаления:"
...
# ===== РЕФЕРАЛЬНАЯ СИСТЕМА =====
# E.* (premium tg-emoji) встраиваются напрямую — работает только в HTML-режиме (parse_mode="HTML")
...
INVITE_FRIEND = (
    ...
    "• Бонусы можно использовать при оплате стрижки\n\n"
...
INVITE_FRIEND_SHARE = (
    f"{E.BARBER} Я делаю маникюр в <b>{{name}}</b>!\n\n"
    f"{E.SCISSORS} Профессиональные нейл-мастера, удобная онлайн-запись.\n"
