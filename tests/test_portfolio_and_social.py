...
class TestPhoneNormalization:
    ...
    def test_kazakhstan_phone_normalized_to_e164(self):
        from handlers.start import _normalize_phone

        assert _normalize_phone("+7 700 123 45 67") == "+77001234567"
        assert _normalize_phone("87001234567") == "+77001234567"
        assert _normalize_phone("7001234567") == "+77001234567"

    def test_invalid_phone_rejected(self):
        from handlers.start import _normalize_phone

        assert _normalize_phone("+7 700 123") is None
        assert _normalize_phone("+1 700 123 45 67") is None
