...
# HIGH-004 FIX: SPREADSHEET_ID removed (Google Sheets not implemented)

# База данных
DB_PATH = os.getenv("DB_PATH", "/app/data/nailshop.db")
TIMEZONE = os.getenv("TIMEZONE", "Asia/Almaty")

# ========================================\r\n# НАСТРОЙКИ СТУДИИ МАНИКЮРА\r\n# ========================================

BARBERSHOP_NAME = "Студия маникюра «Nail Art»"
...
MASTERS = {
    "Анна": {"experience": "5 лет",  "specialization": "классический маникюр, гель-лак, дизайн"},
    "Виктория":   {"experience": "4 года", "specialization": "наращивание ногтей, коррекция, дизайн"},
    "Екатерина":  {"experience": "3 года", "specialization": "аппаратный маникюр, педикюр, покрытие"},
}
