...
# Legacy compatibility stub. Multi-master notifications are not used in the
# single-master version; the bot notifies admins via config.ADMIN_IDS only.
MASTER_IDS: dict = {}
...
async def load_config_from_db():
    ...
    try:
        ...
        if durations:
            ...
            SERVICE_DURATIONS.update(durations)
